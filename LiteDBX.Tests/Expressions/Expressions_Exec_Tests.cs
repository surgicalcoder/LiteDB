...
namespace LiteDbX.Tests.Expressions;

public class ExpressionsExec_Tests
{
    public BsonDocument J(string j)
    {
        return JsonSerializer.Deserialize(j).AsDocument;
    }
    ...
    public void Expressions_Scalar_Parameters()
    {
        ...
        // using map
        P("ARRAY(MAP(ITEMS(@0) => (@ + @1)))", new BsonArray(10, 11, 12), 5)
            .ExpectArray(15, 16, 17);

        // sort ascending
        P("ARRAY(SORT(ITEMS(@0) => @, @1))", new BsonArray(30, 20, 50), 1)
            .ExpectArray(20, 30, 50);

        P("ARRAY(SORT(ITEMS(@0) => @, @1))", new BsonArray(30, 20, 50), "asc")
            .ExpectArray(20, 30, 50);
        ...
        P("ARRAY(SORT(ITEMS(@0) => @, @1))", new BsonArray(30, 20, 50), "desc")
            .ExpectArray(50, 30, 20);
    }
