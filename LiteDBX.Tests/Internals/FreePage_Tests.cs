...
public class FreePage_Tests
{
    ...
    public void FreeSlot_Insert()
    {
        using (var e = new LiteEngine())
        {
            ...
            e.Insert("col1", new[] { new BsonDocument { ["n"] = new byte[200] } }, BsonAutoId.Int32);
            ...
            e.Insert("col1", new[] { new BsonDocument { ["n"] = new byte[600] } }, BsonAutoId.Int32);
            ...
            e.Insert("col1", new[] { new BsonDocument { ["n"] = new byte[6000] } }, BsonAutoId.Int32);
            ...
            e.Insert("col1", new[] { new BsonDocument { ["n"] = new byte[10] } }, BsonAutoId.Int32);
            ...
            e.Insert("col1", new[] { new BsonDocument { ["n"] = new byte[7000] } }, BsonAutoId.Int32);
    ...
    public void FreeSlot_Delete()
    {
        using (var e = new LiteEngine())
        {
            ...
            // first page
            e.Insert("col1", new[] { new BsonDocument { ["_id"] = 1, ["n"] = new byte[2000] } }, BsonAutoId.Int32);
            e.Insert("col1", new[] { new BsonDocument { ["_id"] = 2, ["n"] = new byte[2000] } }, BsonAutoId.Int32);
            e.Insert("col1", new[] { new BsonDocument { ["_id"] = 3, ["n"] = new byte[2000] } }, BsonAutoId.Int32);

            // second page
            e.Insert("col1", new[] { new BsonDocument { ["_id"] = 4, ["n"] = new byte[2000] } }, BsonAutoId.Int32);
            e.Insert("col1", new[] { new BsonDocument { ["_id"] = 5, ["n"] = new byte[2000] } }, BsonAutoId.Int32);
            e.Insert("col1", new[] { new BsonDocument { ["_id"] = 6, ["n"] = new byte[2000] } }, BsonAutoId.Int32);
