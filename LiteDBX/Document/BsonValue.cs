...
public class BsonValue : IComparable<BsonValue>, IEquatable<BsonValue>
{
    ...
    /// </summary>
    public static BsonValue Null = new(BsonType.Null, null);

    /// <summary>
    /// Represent a MinValue bson type
    /// </summary>
    public static BsonValue MinValue = new(BsonType.MinValue, "-oo");

    /// <summary>
    /// Represent a MaxValue bson type
    /// </summary>
    public static BsonValue MaxValue = new(BsonType.MaxValue, "+oo");
    ...
    internal virtual int GetBytesCount(bool recalc)
    {
        switch (Type)
        {
            ...
            case BsonType.String: return StringEncoding.UTF8.GetByteCount(AsString);
