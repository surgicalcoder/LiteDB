...
/// <summary>
/// Using Expressions is the easy and fast way to create classes, structs, get/set fields/properties. But it not works in
/// NET35
/// </summary>
internal partial class Reflection
{
    ...
    public static GenericSetter CreateGenericSetter(Type type, MemberInfo memberInfo)
    {
        ...
        {
            return memberInfo is FieldInfo ? fieldInfo.SetValue : (t, v) => propertyInfo.SetValue(t, v, null);
        }

        var dataType = memberInfo is PropertyInfo ? propertyInfo.PropertyType : fieldInfo.FieldType;
        ...
        var accessor = memberInfo is PropertyInfo ? Expression.Property(castTarget, propertyInfo) : Expression.Field(castTarget, fieldInfo);
