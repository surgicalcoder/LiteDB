...
internal partial class Reflection
{
    ...
    private static readonly Dictionary<Type, CreateObject> _cacheCtor = new();
    ...
    /// </summary>
    public static readonly Dictionary<Type, PropertyInfo> ConvertType = new()
    {
    ...
    private static readonly Dictionary<MethodInfo, string> _cacheName = new();
