...
/// <summary>
/// Implement a temporary stream that uses MemoryStream until get LIMIT bytes, then copy all to tempoary disk file and
/// delete on dispose
/// Can be pass
/// </summary>
public class TempStream : Stream
{
    ...
    public override long Seek(long offset, SeekOrigin origin)
    {
        ...
        if (position > _maxMemoryUsage && InMemory)
        {
            ...
            var file = new FileStream(Filename, FileMode.CreateNew, FileAccess.ReadWrite, FileShare.None, PAGE_SIZE, FileOptions.RandomAccess);
