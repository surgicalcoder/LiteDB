...
///   <item><see cref="Clear"/> and <see cref="RestoreIndex(HeaderPage, CancellationToken)"/>
///     support async WAL bootstrap during engine startup.</item>
/// </list>
/// </summary>
internal class WalIndexService
{
    ...
    // -- RestoreIndex (async startup path) ------------------------------------
