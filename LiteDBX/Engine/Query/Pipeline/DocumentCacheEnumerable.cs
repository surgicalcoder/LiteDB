...
/// Used in GroupBy operation and MUST read all IEnumerable source before dispose because are need be linear from main
/// resultset
/// </summary>
internal class DocumentCacheEnumerable : IEnumerable<BsonDocument>, IDisposable
{
    private readonly List<PageAddress> _cache = new();
