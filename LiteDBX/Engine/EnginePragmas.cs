...
internal class EnginePragmas
{
    ...
    public EnginePragmas(HeaderPage headerPage)
    {
        ...
        {
            [Engine.Pragmas.USER_VERSION] = new()
            {
    ...
    /// <summary>
    /// Define collation for this database. Value will be persisted on disk at first write database. After this, there is no
    /// change of collation
    /// </summary>
